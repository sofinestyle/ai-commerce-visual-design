...
- When the user confirms a design plan and copy, generate from the confirmed plan items with `copyMode: "user_confirmed"`. If the user confirms only angles or scenes but not exact copy, use `copyMode: "auto"`.
